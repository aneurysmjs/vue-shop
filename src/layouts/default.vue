...
<template>
  <div class="bg-white">
                ...
                <div class="border-b border-gray-200">
                  <TabList class="-mb-px flex space-x-8 px-4">
                    ...
                    >
                      <button
                        class="
                          flex-1 whitespace-nowrap border-b-2 px-1 py-4
                  ...
                  <div class="inline-block">
                    ...
                    >
                      <select
                        ...
                        name="currency"
                        class="
                          flex items-center rounded-md border-transparent
                          bg-none py-0.5 pl-2 pr-5 text-sm font-medium
                          text-gray-700
    ...
    <div class="relative bg-gray-900">
                ...
                <div>
                  ...
                  >
                    <select
                      ...
                      class="
                        flex items-center rounded-md border-transparent
                        bg-gray-900 bg-none py-0.5 pl-2 pr-5 text-sm font-medium
                        text-white
      ...
      <!-- <div
        class="
          relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32
          text-center
      ...
      >
        ...
        <a
          href="#"
          class="
            mt-8 inline-block rounded-md border border-transparent bg-white px-8
            py-3 text-base font-medium text-gray-900
          ...
          >
            ...
            >
              ...
              <input
                ...
                required=""
                class="
                  w-full min-w-0 appearance-none rounded-md border border-white
                  bg-white px-4 py-2 text-base text-gray-900
              ...
              <div class="ml-4 flex-shrink-0">
                <button
                  ...
                  class="
                    ...
                    border-transparent bg-indigo-600 px-4 py-2 text-base
